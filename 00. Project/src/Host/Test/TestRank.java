...
public class TestRank {
	...
	public static void straight_check(Rank calrank){
		...
		flop[4]=new Card(1,5);
		Card[][]hand=new Card[8][2];
		hand[0][0]=new Card(6,10);
		hand[0][1]=new Card(6,2);
		hand[1]=null;
		hand[2][0]=new Card(1,6);
		hand[2][1]=new Card(2,7);
		hand[3][0]=new Card(3,6);
		hand[3][1]=new Card(3,6);
		hand[4][0]=new Card(1,7);
		hand[4][1]=new Card(2,7);
		hand[5][0]=new Card(3,1);
		hand[5][1]=new Card(4,5);
		hand[6]=null;
		hand[7]=null;
